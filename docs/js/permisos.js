import { db, collection, addDoc, getDocs, doc, Timestamp } from "./db.js?v=8";
import { abrirModal, cerrarModal, calcularEstadoPermiso, pillHtml, gaugeHtml, formatFecha } from "./utils.js?v=8";
