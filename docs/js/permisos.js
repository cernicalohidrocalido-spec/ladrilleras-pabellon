import { db, collection, addDoc, getDocs, doc, Timestamp } from "./db.js?v=4";
import { abrirModal, cerrarModal, calcularEstadoPermiso, pillHtml, gaugeHtml, formatFecha } from "./utils.js?v=4";
